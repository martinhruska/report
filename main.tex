...
\begin{abstract}
The proposed Ph.D. thesis deals with \emph{shape analysis}\,---\,a field of static analysis
...
Since the data structures allocated on the heap can be viewed as graphs decomposable
...
\begin{enumerate*}[label=(\alph*)]
	...
	\item designing a new kind of automata with a higher expressivity than forest automata but also with decidable important
...
Chapter \ref{ch:vmcai} describes already achieved results on abstraction refinement for forest automata.
...
of selector names.
	  ...
	  The separation-logic-based approa\-ches also ofter suffer from the need to manually provide inductive predicates
	...
	The various heuristics preventing the state explosion during language inclusion checking were introduced,
...
\label{ch:goals}
	...
	An abstraction based on the principles of abstract regular model checking
	is performed over forest automata during the verification procedure to overapproximate the set of reachable
	heap configurations.
	...
	for symbolic automata which will be useful for further research.
	...
	the main scientific contribution of the thesis will be a design of efficient algorithms
	for a manipulation with the new automata.
	...
	how automata run over a processed graph accepting all the spanning trees of the represented graphs.
...
It participated in the memory safety related categories of the last three editions of SV-COMP \cite{www:svcomp}.
...
sub-goal started as a development of a library for an easy prototyping
